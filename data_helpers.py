...
def run_n4_iteratively():
    for index in range(1, 101):
        ...
        outputPath = (
            "/home/sabino/task_driven_data_augmentation/dataset/bias_correct/patient"
            + test_id
        )
    ...
    s.run(
        [
            ...
            "/home/sabino/task_driven_data_augmentation/dataset/bias_correct/patient090/patient090_frame04.nii.gz",
            "0.001",
        ]
    )
