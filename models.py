...
class modelObj:
    ...
    ############################################
        ...
        # For dice score summary
        vag_dice = tf.placeholder(tf.float32, shape=[], name='vag_dice')
        vag_dice_summary = tf.summary.scalar('vag_val_dice', vag_dice)
        rec_dice = tf.placeholder(tf.float32, shape=[], name='rec_dice')
        rec_dice_summary = tf.summary.scalar('rec_val_dice', rec_dice)
        #lv_dice = tf.placeholder(tf.float32, shape=[], name='lv_dice')
        #lv_dice_summary = tf.summary.scalar('lv_val_dice', lv_dice)
        ...
        #val_dsc_summary = tf.summary.merge([mean_dice_summary,rv_dice_summary,myo_dice_summary,lv_dice_summary])
        val_dsc_summary = tf.summary.merge([mean_dice_summary,vag_dice_summary,rec_dice_summary])
        ...
        'flow_vec':flow_vec,'vag_dice':vag_dice,'rec_dice':rec_dice,'mean_dice':mean_dice,'val_dsc_summary':val_dsc_summary,\
        'val_totalc':val_totalc,'val_summary':val_summary}
