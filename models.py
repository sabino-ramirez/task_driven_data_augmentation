...
class modelObj:
    ...
    ############################################
        ...
        val_dsc_summary = tf.summary.merge([mean_dice_summary,rv_dice_summary,myo_dice_summary])
        ...
        return {'x': x, 'y_l':y_l, 'train_phase':train_phase,'select_mask': select_mask,'seg_cost': cost_seg, \
                ...
                'rv_dice':rv_dice,'myo_dice':myo_dice,'mean_dice':mean_dice,'val_dsc_summary':val_dsc_summary,\
    ...
    ############################################
        ...
        # val_dsc_summary = tf.summary.merge([mean_dice_summary,rv_dice_summary,myo_dice_summary,lv_dice_summary])
        # val_dsc_summary = tf.summary.merge([mean_dice_summary,rv_dice_summary,myo_dice_summary])
        val_dsc_summary = tf.summary.merge([mean_dice_summary,rv_dice_summary])
        ...
        # 'flow_vec':flow_vec,'rv_dice':rv_dice,'myo_dice':myo_dice,'mean_dice':mean_dice,'val_dsc_summary':val_dsc_summary,\
        'flow_vec':flow_vec,'rv_dice':rv_dice,'mean_dice':mean_dice,'val_dsc_summary':val_dsc_summary,\
        'val_totalc':val_totalc,'val_summary':val_summary}
